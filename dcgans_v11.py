...
class GAN(keras.Model):
    ...
    def gen_images(self, image_num, latent_dim):
        save_path = "/home/somrawee_a/project-Au/results/DCGANs_v11"
        self.generator = keras.models.load_model(save_path + "/gen_dcgans_v11.h5", compile=False)
        ...
        for i, img in enumerate(generated_images):
            ...
            img.save("/home/somrawee_a/project-Au/results/DCGANs_v11/dcgan_gen_%d.png" % (i+1))

    def classify_gen_images(self, images):
        #gen_images = images
        image_num = len(images)
        pred_prob=[]
        self.discriminator = keras.models.load_model("/home/somrawee_a/project-Au/results/DCGANs_v11/dis_dcgans_v11.h5", compile=False)
    ...
    def plot_graph_loss(self, gen_losses, disc_losses):
        ...
        savemodelpath="/home/somrawee_a/project-Au/results/DCGANs_v11"
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if epoch % 10000 == 0:
            ...
            for i in range(self.num_img):
                img = keras.preprocessing.image.array_to_img(generated_images[i])
                img.save("/home/somrawee_a/project-Au/results/DCGANs_v11/generated_img_%06d_%d.png" %(epoch, i))
            self.model.generator.save('/home/somrawee_a/project-Au/results/DCGANs_v11/dcganv11_gen_model_%d.h5' %epoch)
