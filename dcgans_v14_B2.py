...
# Version 14B2 - d_optimizer (learning rate = 0.00005), g_optimizer (learning rate = 0.0002)
#--------------------------------------------------------------------------------------------------------------
...
#        return inception_scores
    ...
    def plot_graph_loss(self, gen_losses, disc_losses):
        ...
        savemodelpath="/home/somrawee_a/project-Au/results/DCGANs_v14B2"
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if epoch % 10000 == 0:
            ...
            for i in range(self.num_img):
                ...
                img.save("/home/somrawee_a/project-Au/results/DCGANs_v14B2/generated_img_%06d_%d.png" %(epoch, i))
            self.model.generator.save('/home/somrawee_a/project-Au/results/DCGANs_v14B2/dcganv14B2_gen_model_%d.h5' %epoch)
