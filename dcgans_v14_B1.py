...
# Version 14B1 - d_optimizer (Learning rate = 0.0002), g_optimizer (learning rate = 0.0002) same as original version
#--------------------------------------------------------------------------------------------------------------
...
#        return inception_scores
    ...
    def plot_graph_loss(self, gen_losses, disc_losses):
        ...
        savemodelpath="/home/somrawee_a/project-Au/results/DCGANs_v14B1"
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if epoch % 10000 == 0:
            ...
            for i in range(self.num_img):
                ...
                img.save("/home/somrawee_a/project-Au/results/DCGANs_v14B1/generated_img_%06d_%d.png" %(epoch, i))
            self.model.generator.save('/home/somrawee_a/project-Au/results/DCGANs_v14B1/dcganv14B1_gen_model_%d.h5' %epoch)
