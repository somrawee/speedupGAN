...
# Version 12 - original DCGANs
# Version 12A - use wasserstein_loss 
...
#        return inception_scores
    ...
    def plot_graph_loss(self, gen_losses, disc_losses):
        ...
        savemodelpath="/Users/somrawee/project-Au/results/DCGANs_v12A"
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if epoch % 1000 == 0:
            ...
            for i in range(self.num_img):
                ...
                img.save("/Users/somrawee/project-Au/results/DCGANs_v12A/generated_img_%06d_%d.png" %(epoch, i))

            #self.model.generator.save('/home/somrawee_a/project-Au/results/DCGANs_v12/dcganv11_gen_model_%d.h5' %epoch)
            self.model.generator.save('/Users/somrawee/project-Au/results/DCGANs_v12A/dcganv12A_gen_model_%d.h5' %epoch)
        #if epoch == epochs:
...
gan.compile(
    ...
    g_optimizer=keras.optimizers.Adam(learning_rate=0.0000001, beta_1=0.5),
    
    loss_fn=keras.losses.BinaryCrossentropy(),
    #loss_fn=gan.wasserstein_loss
)
