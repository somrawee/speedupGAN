...
#        return inception_scores
    ...
    def plot_graph_loss(self, gen_losses, disc_losses):
        ...
        savemodelpath="/home/somrawee_a/project-Au/results/DCGANs_v14A"
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if epoch % 1000 == 0:
            ...
            for i in range(self.num_img):
                ...
                img.save("/home/somrawee_a/project-Au/results/DCGANs_v14A/generated_img_%06d_%d.png" %(epoch, i))
            self.model.generator.save('/home/somrawee_a/project-Au/results/DCGANs_v14A/dcganv11_gen_model_%d.h5' %epoch)
